...
def load_data(directory):
    ...
    """
    loader_txt = DirectoryLoader(directory,
                                 glob="./**/*.txt",
                                 loader_cls=TextLoader)
    loader_pdf = DirectoryLoader(directory,
                                 glob="./**/*.pdf",
                                 loader_cls=PyPDFLoader)
    loader_csv = DirectoryLoader(directory,
                                 glob="./**/*.csv",
...
def prep_data(in_data):
    ...
    if input_type == 'directory':
        ...
        raise ValueError(f"Error: Data '{in_data}' must be a directory, a"
                         "zip file, or a URL.")
